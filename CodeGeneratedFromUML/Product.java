...
public abstract class Product {
    ...
    public Product(int productId, AuthenticatedStudent owner, String productName, String productDesc) {
        ...
        if (productDesc == null || productDesc.isEmpty()) throw new IllegalArgumentException("Product description cannot be null or empty.");
